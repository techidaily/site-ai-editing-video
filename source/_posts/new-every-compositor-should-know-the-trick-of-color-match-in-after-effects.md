...
categories: 
  - ai
description: This Article Describes New Every Compositor Should Know The Trick of Color Match in After Effects
excerpt: This Article Describes New Every Compositor Should Know The Trick of Color Match in After Effects
keywords: how to use lumetri color in after effects,ai animation how to use lumetri color in after effects,every compositor should know the trick of color match in after effects,ai animation every compositor should know the tips of color match in after effects,every compositor should know the tips of color match in after effects,ai animation every compositor should know the trick of color match in after effects,ai animation ai animation every compositor should know the trick of color match in after effects
