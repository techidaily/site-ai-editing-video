...
categories: 
  - ai
description: This Article Describes How to Create a Light Sweep (Shine) Effect with Filmora
excerpt: This Article Describes How to Create a Light Sweep (Shine) Effect with Filmora
keywords: ai animation how to create a text effect video with filmora,how to create a light sweep shine effect with filmora,how to create a light sweep shine effect,ai animation how to create a light sweep shine effect with filmora,how to create a text effect video with filmora,how to make ninja jump effect with filmora,create a light sweep shine effect
